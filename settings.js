...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "eBYnRDQL#fSNMzMD4P7Rba3aoKR7iahyXtdqS887nAXosviAsjo8", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: prlocess.env.OWNER_NUMBER || "94772045782",
DEV: process.env.DEV || "94772045782",
